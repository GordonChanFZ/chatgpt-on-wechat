...
def run():
    ...
    credentials_file = path.join(current_dir, './config/credentials.txt')
    config_file = path.join(current_dir, './config/config.json')
    tokens_file = path.join(current_dir, './config/tokens.json')
